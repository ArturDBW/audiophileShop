...
export const FinalInfo = ({ fullOrderPrice }) => {
  ...
  return (
    <div className="absolute  left-0 top-0  h-full w-full overflow-hidden bg-black bg-opacity-20">
      <div className="absolute bottom-2/4 right-2/4 translate-x-2/4 translate-y-1/2 rounded-lg bg-white p-6 max-sm:w-11/12 max-sm:p-3">
        <OrderConfirmation />
        <h2 className="my-4 text-3xl font-bold max-sm:text-2xl">
